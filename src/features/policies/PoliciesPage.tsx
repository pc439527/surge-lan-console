    ...
    <div className="space-y-6">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-sm text-text-secondary">策略组及其选项</p>
        </div>
      </header>
                    ...
                    <div className="mt-2 space-y-1">
                      {group.policies.map((policyName) => {
                        ...
                        return (
                          <div
                            key={policyName}
                            className="flex items-center justify-between rounded-sm px-2 py-1.5 hover:bg-elevated/60"
                          >
                            <button
                              type="button"
                            ...
                            <Button size="sm" variant="ghost" onClick={() => testGroup.mutate(group.name)} disabled={testGroup.isPending}>
